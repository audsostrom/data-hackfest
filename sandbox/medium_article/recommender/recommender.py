...
class personalisedSearcher:
    def __init__(self):
        ...
        self.ratings = pd.read_csv("../../data/grouplens/ml-25m/ratings.csv")
    ...
    def get_candidate_movies(self, query):
        ...
        # Query Annoy Index
        nearest_ids = self.index.get_nns_by_vector(query_embeddings[0].numpy(), 10)  # Find 10 nearest neighbors
